...
public class AlfaBetaPlayer extends Player {
    ...
    public int turno(Grid tablero, int conecta) {
        ...
        for (int movimiento : movimientos) {
            ...
            int nivelMaximo = 8; // Establecer el nivel máximo deseado
            int valorMovimiento = alfaBeta(nuevoTablero, Integer.MIN_VALUE, Integer.MAX_VALUE, false, 0, nivelMaximo);
    ...
    private int alfaBeta(Grid tablero, int alfa, int beta, boolean esMaximizador, int nivel, int nivelMaximo) {
        ...
        if (esMaximizador) {
            ...
            for (int movimiento : movimientos) {
                ...
                // Realizar el movimiento en el nuevo tablero
                nuevoTablero.set(movimiento, AI);
                // Llamar recursivamente al algoritmo alfa-beta para el siguiente nivel
                int valorMovimiento = alfaBeta(nuevoTablero, alfa, beta, false, nivel + 1, nivelMaximo);
                ...
                // Realizar la poda beta si es necesario
                if (beta <= alfa) {
                    break;
                }
            }
            ...
            for (int movimiento : movimientos) {
                ...
                // Llamar recursivamente al algoritmo alfa-beta para el siguiente nivel
                int valorMovimiento = alfaBeta(nuevoTablero, alfa, beta, true, nivel + 1, nivelMaximo);
                ...
                // Realizar la poda alfa si es necesario
                if (beta <= alfa) {
                    break;
                }
            }
